   ...
   if(argc > 1)
   {
      ...
      if(pos != npos)
      {
        ...
        if(myfile.is_open())
        {
           ...
           myfile.close();
	   //QUICKSORT IMPORTED VECTOR
           cout << "\033[1;36mSorting...\033[0m" <<endl;
           auto t1 = chrono::high_resolution_clock::now();
           quicksort(arr, 0, myvec.size()-1, myvec.size());
	   auto t2 = chrono::high_resolution_clock::now();
           ...
           cout << "\033[1;36mQuicksort\033[0m- " << chrono::duration_cast<chrono::milliseconds>(t2-t1).count() << "\033[0m milliseconds" << endl;
        }else{
